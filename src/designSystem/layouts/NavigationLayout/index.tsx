...
export const NavigationLayout: React.FC<Props> = ({ children }) => {
  ...
  const items: NavigationItem[] = [
    ...
    {
      key: '/projects/create',
      label: 'Create/Edit Project Page',
      position: 'leftbar',
    ...
    {
      key: '/api-keys',
      label: 'API Keys Management Page',
      position: 'leftbar',
...

    {
      ...
      label: 'Notification Settings Page',
      position: 'leftbar',
...

    {
      ...
      label: 'Customization & Themes Page',
      position: 'leftbar',

      onClick: () => goTo('/settings/customization'),
    },
  ]
